...
export const generateLeads = async (
  ...
  if (params.searchType === 'b2c') {
    ...
    systemInstruction = `
      ...
      3. Do NOT hallucinate contact info. If you can't find a specific email, leave it empty or provide a generic one found on the site.
...
export const enrichCompanyData = async (
  ...
  const prompt = `
    ...
    2. **Find Socials**: Search for their official X (Twitter), Instagram, Facebook, and LinkedIn handles.
